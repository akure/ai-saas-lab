...
import { LayoutDashboard, Key, Sliders, BarChart3, FileJson, Terminal, ShieldAlert } from 'lucide-react';

export type TabId = 'overview' | 'api-keys' | 'metering' | 'analytics' | 'json-studio' | 'api-tester';
